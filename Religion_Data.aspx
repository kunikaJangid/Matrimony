<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Religion_Data.aspx.cs" Inherits="Religion_Data" %>
...
<body bgcolor="darkseagreen">
    ...
    <div>
        ...
        <asp:Label ID="Label1" runat="server" BackColor="Orange" BorderColor="Chocolate"
            Font-Bold="True" Font-Size="X-Large" ForeColor="White" Height="27px" Text="Religion_Data"
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" CellPadding="4" ForeColor="#333333" GridLines="None"
            Height="382px" ShowFooter="True" Width="843px" Font-Bold="True" Font-Size="Large" OnRowDeleting="GridView1_RowDeleting1" OnRowEditing="GridView1_RowEditing1">
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <FooterTemplate>
                        <asp:Button ID="BInsert" runat="server" OnClick="BInsert_Click" Text="Insert" />
                    </FooterTemplate>
                </asp:TemplateField>
            </Columns>
